        ...
        <nav className="navbar navbar-default">
          <div className="container-fluid">
            ...
            <ul className="nav navbar-nav">
              ...
              <li>
                <MyLink to="/register" rendered={!this.state.loggedIn}>
                  Register
                </MyLink>
              </li>
              <li>
                <MyLink to="/users" rendered={this.state.loggedIn}>
                  Users
                </MyLink>
              </li>
              <li>
                <MyLink to="/messages" rendered={this.state.loggedIn}>
                  Messages
                </MyLink>
              </li>
              <li>
                <MyLink to="/profile" rendered={this.state.loggedIn}>
                  My Profile
                </MyLink>
              </li>
            </ul>
            <ul className="nav navbar-nav navbar-right">
              ...
              <li>
                <MyLink to="/login" rendered={!this.state.loggedIn}>
                  Login
                </MyLink>
                <MyLink
                  to="/login"
                  onClick={this.logoutClicked}
                  rendered={this.state.loggedIn}
                >
                  Logout
                </MyLink>
              </li>
